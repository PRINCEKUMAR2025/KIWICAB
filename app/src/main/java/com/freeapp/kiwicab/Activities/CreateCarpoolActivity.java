...
public class CreateCarpoolActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void createCarpool() {
        ...
        com.freeapp.kiwicab.Model.Location pickupLocationObj =
                new com.freeapp.kiwicab.Model.Location(pickupLocation.latitude, pickupLocation.longitude, pickupAddress);

        com.freeapp.kiwicab.Model.Location destinationLocationObj =
                new com.freeapp.kiwicab.Model.Location(destinationLocation.latitude, destinationLocation.longitude, destinationAddress);
