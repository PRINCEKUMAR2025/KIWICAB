...
import com.example.kiwicab.Adapters.TransactionAdapter;
...
public class DriverEarningsActivity extends AppCompatActivity {
    ...
    private List<com.example.kiwicab.Model.Transaction> transactionList;
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    com.example.kiwicab.Model.Transaction transaction =
                            dataSnapshot.getValue(com.example.kiwicab.Model.Transaction.class);
                ...
                withdrawalsQuery.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                            com.example.kiwicab.Model.Transaction withdrawal =
                                    dataSnapshot.getValue(com.example.kiwicab.Model.Transaction.class);
                        ...
                        Collections.sort(transactionList, new Comparator<com.example.kiwicab.Model.Transaction>() {
                            @Override
                            public int compare(com.example.kiwicab.Model.Transaction t1, com.example.kiwicab.Model.Transaction t2) {
